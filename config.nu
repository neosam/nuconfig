...
module completions {
  ...
  def "nu-complete git branches" [] {
    ^git branch -a | lines | each { |line| $line | str find-replace '\* ' '' | str trim | str find-replace '^remotes/' '' }
  }
  ...
  export extern "git switch" [
    branch1: string@"nu-complete git branches"
    branch2?: string@"nu-complete git branches"
    --create(-c)
    --force-create(-C)
  ]
}
